# Generated by Django 4.2.16 on 2024-12-01 06:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('questions', models.ManyToManyField(related_name='question_banks', to='exam.question')),
            ],
        ),
        migrations.CreateModel(
            name='Exam',
            fields=[
                ...
                ('question_bank', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exams', to='exam.questionbank')),
